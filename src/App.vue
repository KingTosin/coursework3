<template class="bg-dark">
  ...
  <div id="app" class="bg-dark">
    ...
    <!-- <link rel="stylesheet" type="text/css" href="style.css"> -->
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow p-3 mb-3 bg-dark ">
        ...
        <div v-if="showLessons" class="bg-dark" >
            ...
            <div  class="checkoutPage" v-else  style="color: white; flex-direction: column; justify-content: center; display: flex; align-items: center; font-family: Poppins; " >
